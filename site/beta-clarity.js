(() => {
  ...
  function home() {
    ...
    if (actions) actions.innerHTML = `<a class="btn primary" href="signals.html#morning-desk">See the live desk →</a><a class="btn secondary" href="#how-it-works">How do I use this?</a><a class="btn secondary" href="${memberUrl}">Member access</a>`;
    ...
    if (consolePanel) {
      ...
      consolePanel.innerHTML = `
        ...
        <div class="beta-proof-foot">Illustrative product view. Historical strategy research stays in Research &amp; Evidence.</div>`;
    }
    ...
    const guide = section(`
      <section class="shell section beta-clarity-section" id="add-a-trade">
        ...
        <div class="beta-journal-how">
          ...
          <article class="beta-journal-option"><span class="label">Review it</span><h3>Open your private workspace.</h3><p>Use <code>/member-login</code> for a one-time sign-in link. Your private journal, live desk, Indicator Workspace, and Strategy Lab are tied to your Discord identity.</p><span class="command">/member-login</span></article>
        </div>
